...
sources="src/upkg/00-core.u src/upkg/01-model.u src/upkg/02-index.u src/upkg/03-ship.u src/upkg/04-plan.u src/upkg/05-drv.u src/upkg/06-cargo.u src/upkg/07-builders.u src/upkg/08-claims.u src/upkg/09-release.u src/upkg/10-typed.u src/pkgs.u src/site.u"
